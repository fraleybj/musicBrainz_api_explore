...
if __name__ == "__main__":
    ...
    offset_counter = 0
    if offset_counter > 0:
        if os.path.exists('top_artists_by_tag_offset_{0}.data'.format(offset_counter - 25)):
            with open('top_artists_by_tag_offset_{0}.data'.format(offset_counter - 25), 'rb') as fp:
    ...
    while offset_counter < 750:
        ...
        with open('artists_by_tag_offset_{0}.json'.format(offset_counter), 'w') as fp:
        ...
        with open('top_artists_by_tag_offset_{0}.data'.format(offset_counter), 'wb') as fp:
            pickle.dump(top_n, fp)
        fp.close()
        with open('top_artists_by_tag_offset_{0}.json'.format(offset_counter), 'w') as fp:
